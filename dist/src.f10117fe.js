...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"framework/models/Model.ts":[function(require,module,exports) {
"use strict";
...
exports.Model = Model;
},{}],"framework/models/Attributes.ts":[function(require,module,exports) {
"use strict";
...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"framework/models/ApiSync.ts":[function(require,module,exports) {
"use strict";
...
},{"axios":"node_modules/axios/index.js"}],"framework/models/Eventing.ts":[function(require,module,exports) {
"use strict";
...
},{}],"framework/models/Collection.ts":[function(require,module,exports) {
"use strict";
...
},{"./Eventing":"framework/models/Eventing.ts","axios":"node_modules/axios/index.js"}],"src/models/User.ts":[function(require,module,exports) {
"use strict";
...
var Model_1 = require("../../framework/models/Model");

var Attributes_1 = require("../../framework/models/Attributes");

var ApiSync_1 = require("../../framework/models/ApiSync");

var Eventing_1 = require("../../framework/models/Eventing");

var Collection_1 = require("../../framework/models/Collection");
...
exports.User = User;
},{"../../framework/models/Model":"framework/models/Model.ts","../../framework/models/Attributes":"framework/models/Attributes.ts","../../framework/models/ApiSync":"framework/models/ApiSync.ts","../../framework/models/Eventing":"framework/models/Eventing.ts","../../framework/models/Collection":"framework/models/Collection.ts"}],"framework/views/View.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  View.prototype.mapRegions = function (fragment) {
    ...
    for (var key in regionsMap) {
      var htmlElement = fragment.querySelector(regionsMap[key]);
...
var View_1 = require("../../framework/views/View");
...
},{"../../framework/views/View":"framework/views/View.ts"}],"src/views/UserForm.ts":[function(require,module,exports) {
"use strict";
...
},{"../../framework/views/View":"framework/views/View.ts"}],"src/views/UserEdit.ts":[function(require,module,exports) {
"use strict";
...
},{"../../framework/views/View":"framework/views/View.ts","./UserShow":"src/views/UserShow.ts","./UserForm":"src/views/UserForm.ts"}],"framework/views/CollectionView.ts":[function(require,module,exports) {
"use strict";
...
function () {
  function CollectionView(parent, collection) {
    ...
    this.render = function () {
      ...
      for (var _i = 0, _a = _this.collection.model; _i < _a.length; _i++) {
        var model = _a[_i];

        _this.renderItem(model, templateElement.content);
      }
...
var CollectionView_1 = require("../../framework/views/CollectionView");
...
function (_super) {
  ...
  UserList.prototype.template = function () {
    return "\n    <h1>User List</h1>\n    <ul></ul>\n    <br>\n    ";
  };
...
},{"../../framework/views/CollectionView":"framework/views/CollectionView.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
...
if (listElement) {
  new UserList_1.UserList(listElement, User_1.User.buildUserCollection()).render();
}

var rootElement = document.getElementById('root');

if (rootElement) {
  new UserEdit_1.UserEdit(rootElement, user).render();
}
},{"./models/User":"src/models/User.ts","./views/UserEdit":"src/views/UserEdit.ts","./views/UserList":"src/views/UserList.ts"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
